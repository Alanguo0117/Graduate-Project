...
def model(conv1_channel, conv1_ksize, conv2_channel, conv2_ksize, pool_size, drop_rate1, drop_rate2,FC_size, batch_size):
    ...
    conv2_channel=int(conv2_channel)
...
score, model_log = model(conv1_channel, conv1_ksize, conv2_channel, conv2_ksize, pool_size, drop_rate1, drop_rate2,FC_size, batch_size)
'''
